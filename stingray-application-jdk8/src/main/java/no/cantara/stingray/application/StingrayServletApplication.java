...
public abstract class StingrayServletApplication<A extends StingrayServletApplication<A>> implements StingrayApplication<A>, StingrayRegistry {

    private static final Logger log = LoggerFactory.getLogger(StingrayServletApplication.class);
    ...
    protected StingrayServletApplication(String applicationAlias, String version, ApplicationProperties config) {
    ...
    public static String readMetaInfMavenPomVersion(String groupId, String artifactId) {
        ...
        URL mavenVersionResource = StingrayServletApplication.class.getResource(resourcePath);
