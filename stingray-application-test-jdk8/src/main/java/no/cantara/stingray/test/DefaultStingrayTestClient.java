...
public class DefaultStingrayTestClient implements StingrayTestClient {
    ...
    public DefaultStingrayTestClient useFakeApplicationAuth(String applicationId) {
    ...
    public class DefaultFakeApplicationAuthorizationBuilder implements FakeApplicationAuthorizationBuilder {
        ...
        public DefaultStingrayTestClient endFakeApplication() {
            if (authGroups.size() > 0) {
                String accessGroups = String.join(" ", authGroups);
                tags.add(new Tag(WhydahStingrayAuthenticationManagerFactory.DEFAULT_AUTH_GROUP_APPLICATION_TAG_NAME, accessGroups));
            }
            ...
            return DefaultStingrayTestClient.this;
        }
    }
    ...
    public class DefaultFakeUserAuthorizationBuilder implements FakeUserAuthorizationBuilder {
        ...
        public DefaultStingrayTestClient endFakeUser() {
            if (userId == null) {
                throw new IllegalArgumentException("userId cannot be null");
            }
            if (customerRef == null) {
