...
public class StingrayServiceAction {

    public static final StingrayServiceAction ALL_ACTIONS_ON_ALL_SERVICES = new StingrayServiceAction("*", "*");

    private final String service;
    private final String action;
    private final String serviceAndAction;

    public static StingrayServiceAction from(String serviceAndAction) {
        ...
        return new StingrayServiceAction(parts[0], parts[1]);
    }

    public StingrayServiceAction(String service, String action) {
    ...
    public boolean equals(Object o) {
        ...
        StingrayServiceAction action = (StingrayServiceAction) o;
