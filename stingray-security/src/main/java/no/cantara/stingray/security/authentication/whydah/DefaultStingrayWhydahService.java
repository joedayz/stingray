...
public class DefaultStingrayWhydahService implements StingrayWhydahService {

    public static final Logger log = LoggerFactory.getLogger(DefaultStingrayWhydahService.class);

    private static final ObjectMapper mapper = new ObjectMapper();

    private final WhydahApplicationSession2 was;

    public DefaultStingrayWhydahService(WhydahApplicationSession2 was) {
        this.was = was;
    }
    ...
    public List<StingrayApplicationTag> getApplicationTagsFromApplicationTokenId(String applicationTokenId) {
        final String tagsJson = new WhydahCommandGetApplicationTagsFromApplicationTokenId(
                URI.create(was.getSTS()),
                applicationTokenId).execute();
        ...
        try {
            List<StingrayApplicationTag> tags = mapper.readValue(tagsJson, new TypeReference<List<StingrayApplicationTag>>() {
            });
            return tags;
