...
public class WhydahCommandGetApplicationTagsFromApplicationTokenId extends BaseHttpGetHystrixCommand<String> {
    private static final Logger log = LoggerFactory.getLogger(CommandGetApplicationIdFromApplicationTokenId.class);
    public static int DEFAULT_TIMEOUT = 6000;


    public WhydahCommandGetApplicationTagsFromApplicationTokenId(URI tokenServiceUri, String applicationTokenId) {
    ...
    public WhydahCommandGetApplicationTagsFromApplicationTokenId(URI tokenServiceUri, String applicationTokenId, int timeout) {
